          ...
          b-form(@submit='onSubmit' v-if='show')
            ...
            b-form-group.paragraph.m-b-10
              p By signing up, I accept the&nbsp;
                a.link(href="https://www.complect.com/terms-of-use" target="_blank") Complect Terms of Use&nbsp;
                | and acknowledge the&nbsp;
                a.link(href="https://www.complect.com/privacy-policy" target="_blank") Privacy Policy
...
<script>
  ...
  export default {
    // props: ['invite_token', 'inviteToken'],
    components: {
      TopNavbar,
      Loading,
      OtpConfirm
